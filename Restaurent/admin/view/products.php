...
<div class="modal fade" id="addProductModal" tabindex="-1" aria-labelledby="addProductModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="price" name="price" min="10"  max="1000" required>
    </div>
    <div class="form-group">
...
<div class="form-group">
    ...
    <img src="" id="previewImg" alt="Product Image" class="img-fluid mt-2 border" width="100px">
    </div>
   ...
   // $("#productsTable").DataTable();
    ...
    $(document).ready(function () {
        $("#addProductForm").on("submit", function (e) {
            ...
            $.ajax({
                url: "../controller/addProduct_uploadFile_controller.php",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
       ...
       success: function (data) {
          // console .log(data);
           ...
           for (var i = 0; i < items.length; i++) {
            ...
            html += "<tr>";
            html += "<td>" + (i + 1) + "</td>";
            html += "<td><img src='../assets/MenuItems/" + image + "' alt='" + title + "' class='img-thumbnail' width='100px'></td>";
            html += "<td>" + id + "</td>";
            html += "<td>" + title + "</td>";
            html += "<td>" + price + "</td>";
            html += "<td><span class='badge badge-primary'>" + category + "</span></td>";
            html += "<td><span class='badge badge-success'>" + rating + "★</span></td>";
            html += "<td>";
           // html += "<button class='btn btn-sm btn-warning rounded-pill m-1 editBtn' data-id='" + id + "' data-toggle='modal' data-target='#editProductModal'><i class='fa fa-edit'></i></button>";
        ...
        $(document).on("click", "#deleteBtn", function () {
          ...
          $(element).attr("disabled", "disabled");
            ...
            $(element).html(
                ...
                $.ajax({
                    url: "../controller/deleteProduct_controller.php",
                    type: "POST",
                    data: {
                        id: id
                    },
